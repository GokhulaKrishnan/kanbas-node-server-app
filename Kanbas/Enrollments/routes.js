...
//   //   });
//   //////////////////////////
//   // app.get("/api/Dashboard/enrollments/:userId", async (req, res) => {
//   //   const { userId } = req.params;
//   //   const result = await enrollmentsDao.findAllUserEnrollments(userId);
//   //   return res.json(result);
//   // });
//   // app.get("/api/Dashboard/courses", async (req, res) => {
//   //   // const { courseId } = req.params;
//   //   const result = await enrollmentsDao.findAllCourses();
//   //   return res.json(result);
//   // });
//   // // Route to enroll a user in a course
//   // app.post("/api/Dashboard/enrollments/newEnroll", async (req, res) => {
//   //   const newEnroll = req.body;
//   //   const newEnrollment = await enrollmentsDao.enrollUserInCourse(newEnroll);
//   //   res.json(newEnrollment);
//   // });
//   // // Route to unenroll a user from a course
//   // app.delete("/api/Dashboard/enrollments/unenroll", async (req, res) => {
//   //   const { user, course } = req.body;
//   //   await enrollmentsDao.unenrollUserFromCourse(user, course);
